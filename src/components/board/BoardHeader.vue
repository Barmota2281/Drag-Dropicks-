<template>
  <header class="flex items-center justify-between mb-6 pb-4 border-b border-gray-200 dark:border-gray-700 shrink-0 gap-4">
    ...
    <div class="flex items-center gap-3 min-w-0">
      ...
      <button v-if="boardTitle && boardTitle !== 'Задача'" @click="$emit('edit-board')" class="p-1 rounded-md text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all flex-shrink-0" title="Настройки доски">
...
const emit = defineEmits(['add-task', 'jump-to-task', 'edit-board'])
